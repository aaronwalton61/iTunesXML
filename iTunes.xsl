...
<html>
<head>
<!-- <xsl:for-each select='plist/dict">
<title>Music - <xsl:apply-templates select="key[. = 'Date'] mode="content"/></title>
</xsl:for-each> -->
<title>Music</title>
<style>
body { font:normal 10% verdana,arial,helvetica; color:#000000; } th { font:normal 12pt verdana,arial,helvetica; color:#000000; } td { font:normal 8pt verdana,arial,helvetica; color:#000000; }
</style>
</head>
<body>
<table border="0">
...
<tr>
<td bgcolor="ffffcc">
<xsl:apply-templates select="key[. = 'Artist']" mode="content"/>
</td>
<td bgcolor="ccffff">
<xsl:apply-templates select="key[. = 'Album']" mode="content"/>
</td>
<td bgcolor="ffccff">
<xsl:apply-templates select="key[. = 'Name']" mode="content"/>
</td>
<td bgcolor="aaaacc">
<xsl:apply-templates select="key[. = 'Genre']" mode="content"/>
</td>
<td bgcolor="ccaaaa">
...
<i>
iTunes song list generated by
<a href="http://www.edlin.org/xslt/" target="_top">http://www.edlin.org/xslt/</a>
</i>
</td>
</tr>
</table>
